...
This package is also available on \href{https://github.com/silkeh/latex-sourcesans}{GitHub}.
...
\begin{itemize*}
	...
	\item \textbf{medium}:         \texttt{\textbackslash mdseries} is medium (OTF only).
...
Issues can be reported \href{https://github.com/silkeh/latex-sourcesans/issues}{on GitHub}.
